...
## תקציב קרדיטים ב-Make (שני התרחישים יחד)
- התרחיש הזה הוא **Webhook (Instant)** — לא רץ בזמן שקט. עלות רק כשמגיעה הודעה:
  ~2–3 קרדיטים להודעה נכנסת (טריגר + Data store + HTTP), כולל הודעות שנחסמות ככפילות.
- החבילה החינמית: 1,000 קרדיטים בחודש, עד 2 תרחישים פעילים (פייסבוק + וואטסאפ = בדיוק 2).
- חלוקה מומלצת ליעד של ~500 בחודש: פייסבוק כל 120 דק' (~300–320) + וואטסאפ עד ~60–90 הודעות (~180).
  אם הפייסבוק עובר ל-Instant, כל התקציב פנוי לוואטסאפ (~200+ הודעות).
